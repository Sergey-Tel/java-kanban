...
public class Main {
    public static void main(String[] args) {
        ...
        final EpicCards epicCards = new EpicCards("Эпик", "descriptionOfEpic", -1);
        System.out.println("Создаем 2 эпика");
        final EpicCards createdEpicCards = manager.createEpic(epicCards);
        final EpicCards createdEpic1Cards = manager.createEpic(epicCards);
        System.out.println("Печатаем содержание 2х задач");
        System.out.println(createdEpicCards);
        System.out.println(createdEpic1Cards);
        if (!epicCards.equals(createdEpicCards) && !createdEpicCards.equals(createdEpic1Cards)) {
        ...
        ArrayList<EpicCards> epicCardsArrayList = manager.findAllEpics();
        System.out.println("Метод findAllEpics(). Печатаем весь список задач:");
        for (Task value : epicCardsArrayList) {
            System.out.println(value);
        }
        if (epicCardsArrayList.isEmpty()) {
        ...
        final SubTask subTask1 = manager.createSubTask(subTask, createdEpicCards);
        final SubTask subTask2 = manager.createSubTask(subTask, createdEpicCards);
        System.out.println(subTask1);
        System.out.println(subTask2);
        System.out.println("Создаем и печатаем 2 подзадачи другого эпика");
        final SubTask subTask3 = manager.createSubTask(subTask, createdEpic1Cards);
        final SubTask subTask4 = manager.createSubTask(subTask, createdEpic1Cards);
        ...
        EpicCards findEpicCards = manager.findEpicById(1);
        System.out.println("Печатаем найденный эпик");
        System.out.println(findEpicCards);
        if (1 == findEpicCards.getId()) {
